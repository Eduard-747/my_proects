...
template <typename T>
myl::forward_list<T>::iterator::iterator(myl::forward_list<T>::Node<T> * node)
{
    it = node;
}
...
template <typename T>
typename myl::forward_list<T>::iterator& myl::forward_list<T>::iterator::operator++()
{
    it = it->pNext;
    return *this;
}
...
template <typename T>
typename myl::forward_list<T>::iterator myl::forward_list<T>::iterator::operator++(int)
{
    iterator tmp = it;
    it = it->pNext;
    return tmp;
...
template <typename T>
const T& myl::forward_list<T>::iterator::operator*() const
{
    return it->data;
}
...
template <typename T>
typename myl::forward_list<T>::iterator myl::forward_list<T>::begin()
{
    return iterator(head);
}

template <typename T>
typename myl::forward_list<T>::iterator myl::forward_list<T>::end()
{
    Node<T> * cur = head;
    while(cur)
    {
